...
export class InitialEntities1728434593905 implements MigrationInterface {
  name = 'InitialEntities1728434593905';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role__enum" AS ENUM('ADMIN', 'ABOGADO', 'PRACTICANTE')`
    );
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "firstName" character varying(50) NOT NULL, "lastName" character varying(50) NOT NULL, "role_" "public"."users_role__enum" NOT NULL DEFAULT 'PRACTICANTE', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."parts_part__enum" AS ENUM('DENUNCIANTE', 'DENUNCIADO')`
    );
    await queryRunner.query(
      `CREATE TABLE "parts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "part_" "public"."parts_part__enum", "expedientId" uuid, CONSTRAINT "PK_daa5595bb8933f49ac00c9ebc79" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."expedients_status__enum" AS ENUM('TACHADO', 'EJECUCION')`
    );
    await queryRunner.query(
      `CREATE TABLE "expedients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(50) NOT NULL, "subject" character varying(50) NOT NULL, "court" character varying(50) NOT NULL, "status_" "public"."expedients_status__enum" NOT NULL DEFAULT 'EJECUCION', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" uuid, "updatedById" uuid, CONSTRAINT "UQ_ee9a643d474783165de8b3f0aed" UNIQUE ("code"), CONSTRAINT "UQ_c207c5b918ab0d7f162c2e20f9d" UNIQUE ("subject"), CONSTRAINT "UQ_b339c56cc1de0ccd6f8955ec78d" UNIQUE ("court"), CONSTRAINT "REL_fe7270d86781fb5569e3d69720" UNIQUE ("createdById"), CONSTRAINT "REL_cf3e5c578ecfacdb3e43f33b62" UNIQUE ("updatedById"), CONSTRAINT "PK_7abe96162f1ba6457c851d70f65" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."expedients_status__enum"`);
    await queryRunner.query(`DROP TABLE "documents"`);
    await queryRunner.query(`DROP TABLE "parts"`);
    await queryRunner.query(`DROP TYPE "public"."parts_part__enum"`);
    await queryRunner.query(`DROP TABLE "users"`);
    await queryRunner.query(`DROP TYPE "public"."users_role__enum"`);
  }
}
